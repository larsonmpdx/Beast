...
#ifndef BEAST_IMPL_BUFFERED_WRITE_STREAM_IPP
#define BEAST_IMPL_BUFFERED_WRITE_STREAM_IPP
...
template<class MutableBufferSequence, class Handler>
void
buffered_write_stream<Stream, DynamicBuffer>::
